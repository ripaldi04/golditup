            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="flex items-center gap-4">
                        ...
                        <a href="{{ route('register') }}" class="ml-2 text-sm text-gray-600 hover:text-gray-900 underline">
                            {{ __('Register') }}
                        </a>
                    </div>
                @endauth
            ...
            <div class="px-4">
                ...
                @else
                    ...
                    <a href="{{ route('register') }}"
                        class="mt-1 block text-sm text-gray-600 hover:text-gray-900 underline">
                        {{ __('Register') }}
                    </a>
                @endauth
            </div>
